...
| -------------------------------------------------------------------*/
	...
	$folderYear = $_SERVER['DOCUMENT_ROOT']."/z/public_html/uploads/post/" . $year . "/";
	$folderMonth = $_SERVER['DOCUMENT_ROOT']."/z/public_html/uploads/post/" . $year . "/".$month."/";
	$folderDay= $_SERVER['DOCUMENT_ROOT']."/z/public_html/uploads/post/" . $year . "/".$month."/".$day."/";
	...
	$filename = "/z/public_html/uploads/post/" . $year . "/".$month."/".$day;
