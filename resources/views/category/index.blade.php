                      ...
                      @foreach($categories as $parentCategoryKey => $parentCategory)
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a href="{{route('category-edit', $parentCategory->id)}}" class="btn btn-warning">edit</a>
                            
                            <form class="display-inline" method="POST" action="{{route('category-destroy', $parentCategory->id)}}">
