...
{{--
                    <form role="form" method="POST" action="{{route('categoryradar-update', ['id'=>$categoryradarRow->id, 'x'=>'a'])}}">
--}}
                    <form role="form" method="POST" action="{{route('categoryradar-update', $categoryradarRow->id)}}">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" name="name" placeholder="Category Name" value="{{$categoryradarRow->name}}">
                        </div>

                        <div class="form-group">
                            <label for="color">Color</label>
                            <div class="input-group my-colorpicker2 colorpicker-element">
                              <input type="text" class="form-control" id="color" name="color" placeholder="Color Hexa Code" value="{{$categoryradarRow->color}}">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="is_visible" name="is_visible">
                            @if($categoryradarRow->is_visible == 1)
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="news_type_id" name="news_type_id">
                            @if($categoryradarRow->news_type_id == 1)
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="is_fillable" name="is_fillable">
                            @if($categoryradarRow->is_fillable == 1)
