...
{{--
                    <div class="panel-heading">Category Radar</div>                   
                    
--}}
                    <div class="box box-primary">
                        <div class="box-header with-border">
                          <h3 class="box-title">Create Category Radar</h3>                         
                        </div>

                        <form role="form" method="POST" action="{{route('categoryradar-store')}}">
                            <div class="box-body">
                                {{csrf_field()}}
                                <div class="form-group">
                                  <label for="name">Category Radar Name</label>
                                  <input type="text" class="form-control" id="name" name="name" placeholder="Categoryradar Name">
                                </div>
